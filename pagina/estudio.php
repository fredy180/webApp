		...
		<nav class="teal  header">
			<div class="nav-wrapper"> <a href="#" class="brand-logo"><img alt="LOGO" src="../imagenes/logo.png" width="250"></a>
				...
				<ul id="nav-mobile" class="right hide-on-med-and-down">
					<li><a href="index.html"><i class="material-icons left">home</i>INICIO</a>
					</li>
					<li><a href="../php/docente/registroEstudiante.php"><i class="material-icons left">inbox</i>ADMINISTRADOR</a>
					</li>
			...
			<div id="articles">
				<div class="col s12 m7 l9 z-depth-3">
					...
					<div class="row grey lighten-4 z-depth-2" >
						<form class="col s12 m12 l12 " action="insertarComentario.php" method="post">
							<div class="row">
