					...
					<div class="card z-depth-2">
						...
						<ul class="collapsible">
							...
							<li>
								...
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroTema.php" class="collection-item ">NUEVO TEMA</a> <a href="consultaTema.php" class="collection-item active">CONSULTAR TEMA</a> <a href="edicionTema.php" class="collection-item">EDICION TEMA</a> </div>
									</span>
								</div>
							</li>
							<li>
			...
			<div id="articles">
				<div class="col s12 m7 l9 z-depth-3">
					...
					<div class="row">
						...
						<table class="responsive-table highlight bordered" id="tabla">
							<thead>
								<tr class="header">
									<th>CODIGO</th>
									<th>NOMBRE</th>
							...
							<tbody>
								...
								$sql2 = $mysqli->query( "SELECT `idtema`,`nombreTema`,`contenidoTema`, u.nombreUnidad FROM tema i , unidad u WHERE u.idDocente='$id' AND u.idUnidad=i.idUnidad");
								$con = 0;
								while ( $fila = mysqli_fetch_assoc( $sql2 ) ) {
									$con = $con + 1;
									echo "<tr>" .
									"<td>" . $fila[ 'idtema' ] . "</td>" .
									"<td>" . $fila[ 'nombreTema' ] . "</td>" .
									"<td align='justify'>" . $fila[ 'contenidoTema' ] . "</td>" .
