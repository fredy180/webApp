		...
		<nav class="teal  header">
			<div class="nav-wrapper"> <a href="#" class="brand-logo"><img alt="LOGO" src="../../imagenes/logo.png" width="250"></a> <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
				<ul id="nav-mobile" class="right hide-on-med-and-down">
					...
					<li><a href="login.html"><i class="material-icons left">person_outline</i>Entrar</a>
					</li>
				</ul>
						...
						<ul class="collapsible">
							<li>
								...
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroEstudiante.php" class="collection-item">REGISTRAR ESTUDIANTE</a> <a href="consultaEstudiante.php" class="collection-item active">CONSULTAR ESTUDIANTE</a> <a href="edicionEstudiante.php" class="collection-item">EDICION ESTUDIANTE</a> </div>
									</span>
								</div>
							</li>
							<li>
							...
							<li>
								...
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroEvaluacion.php" class="collection-item ">NUEVA UVALUACION</a> <a href="consultaEvaluacion" class="collection-item">CONSULTAR EVALUACION</a> <a href="edicionEvaluacion.php" class="collection-item">EDICION EVALUACION</a> </div>
									</span>
								</div>
							</li>
						</ul>
