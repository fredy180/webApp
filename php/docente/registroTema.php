		...
		<div class="row contenido">
					...
					<div class="card z-depth-2">
						...
						<ul class="collapsible">
							...
							<li>
								...
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroTema.php" class="collection-item active">NUEVO TEMA</a> <a href="consultaTema.php" class="collection-item">CONSULTAR TEMA</a> <a href="edicionTema.php" class="collection-item">EDICION TEMA</a> </div>
									</span>
								</div>
							</li>
							<li>
			...
			<div id="articles">
				<div class="col s12 m7 l9 z-depth-3">
					...
					<div class="row">
						<center>
							<h4>REGISTRAR TEMA <h4></center>
						<hr>
						<form class="col s12" action="insertarTema.php" method="post">
							<div class="row">
								...
								<div class="input-field col s12">
        							 <i class="material-icons prefix">mode_edit</i>
         							 <textarea id="contenido" class="materialize-textarea" name="contenido" data-length="7000"></textarea>
         							 <label for="contenido">CONTENIDO TEMA</label>
        						</div>
        						
        						<div class="input-field col s12 m12 l6 ">
									<input id="imagen" type="text" class="validate "  name="imagen" data-length="500" required>
									<label for="imagen">URL IMAGEN</label>
								</div>
								<div class="input-field col s12 m12 l6 ">
									<input id="video" type="text" class="validate " name="video" data-length="500" required>
									<label for="video">URL VIDEO</label>
								</div>
								
								<div class="col s12 m12 l6">
                             <label>Browser Select</label>
  								<select class="browser-default" required name="unidad">
									<option value="" disabled selected>SELECCIONE UNIDAD</option>
                                <?php
                                require( "../conexion.php" );
								$id=$_SESSION['idAdmin'];

                                $sql2 = $mysqli->query( "SELECT `idUnidad`,`nombreUnidad` FROM `unidad` WHERE idDocente='$id'" );

                                while ( $fila = mysqli_fetch_assoc( $sql2 ) ) {
									$idtema=$fila['idtema'];
									$nombre=$fila['nombreUnidad'];

                                    echo "<option  value='$idtema' >  $nombre </option>";
                                }
                                ?>
                            </select>
