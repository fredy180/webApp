	...
	<body>
				...
				<div class="z-depth-3"> <br>
					...
					<div class="card z-depth-2">
						...
						<ul class="collapsible">
							<li>
								<div class="collapsible-header active"><i class="material-icons">person</i>ESTUDIANTE</div>
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroEstudiante.php" class="collection-item">REGISTRAR ESTUDIANTE</a> <a href="consultaEstudiante.php" class="collection-item ">CONSULTAR ESTUDIANTE</a> <a href="edicionEstudiante.php" class="collection-item active">EDICION ESTUDIANTE</a> </div>
									</span>
								</div>
							</li>
							<li>
					...
					<div class="row  offset-s4 teal ">
						...
						<div class="col s12 m12 l6 ">
							...
							<select class="browser-default filtro white">
								...
								<option value="1">Contrasena</option>
					...
					<div class="row">
						...
						<table class="responsive-table highlight centered bordered" id="tabla">
							...
							<tbody>
								...
								$sql2 = $mysqli->query( "SELECT * FROM `estudiante" );
								$con = 0;
								while ( $fila = mysqli_fetch_assoc( $sql2 ) ) {
									$con = $con + 1;
									echo "<tr>" .
									"<td>" . $fila[ 'idestudiante' ] . "</td>" .
									"<td contenteditable='true'> " . $fila[ 'contrasena' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'nombre' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'apellido' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'edad' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'grado' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'sexo' ] . "</td>" .
									"<td>" .
		...
		<script>
			...
			function actualizar( id_fila ) {
				...
				var contrasena = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 1 ).innerHTML;
				var nombre = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 2 ).innerHTML;
				var apellido = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 3 ).innerHTML;
				var edad = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 4 ).innerHTML;
				var grado = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 5 ).innerHTML;
				var sexo = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 6 ).innerHTML;

				$.ajax( {
					url: "actualizarEstudiante.php",
					method: "POST",
					data: {
