		...
		<div class="row contenido">
					...
					<div class="card z-depth-2">
						...
						<ul class="collapsible">
							...
							<li>
								...
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroUnidad.php" class="collection-item active ">NUEVA UNIDAD</a> <a href="consultaUnidad.php" class="collection-item">CONSULTAR UNIDAD</a> <a href="edicionUnidad.php" class="collection-item">EDICION UNIDAD</a> </div>
									</span>
								</div>
							</li>
							<li>
			...
			<div id="articles">
				<div class="col s12 m7 l9 z-depth-3">
					...
					<div class="row">
						<center><h4>REGISTRAR UNIDAD</h4></center>
						<hr>
						<form class="col s12" action="insertarUnidad.php" method="post">
							<div class="row">
