		...
		<div class="row contenido">
						...
						<ul class="collapsible">
							<li>
								...
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="#!" class="collection-item active">REGISTRAR ESTUDIANTE</a> <a href="consultaEstudiante.php" class="collection-item ">CONSULTAR ESTUDIANTE</a> <a href="edicionEstudiante.php" class="collection-item">EDICION ESTUDIANTE</a> </div>
									</span>
								</div>
							</li>
							<li>
			...
			<div id="articles">
				<div class="col s12 m7 l9 z-depth-3">
					...
					<div class="row">
						<center><h4>REGISTRAR ESTUDIANTE</h4></center>
						<hr>
						<form class="col s12" action="insertarEstudiante.php" method="post">
							<div class="row">
