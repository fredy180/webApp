	...
	<body>
				...
				<div class="z-depth-3"> <br>
					...
					<div class="card z-depth-2">
						...
						<ul class="collapsible">
							...
							<li>
								<div class="collapsible-header active"><i class="material-icons">assignment</i>UNIDADES</div>
								<div class="collapsible-body">
									<span>
										<div class="collection"> <a href="registroUnidad.php" class="collection-item ">NUEVA UNIDAD</a> <a href="consultaUnidad.php" class="collection-item">CONSULTAR UNIDAD</a> <a href="edicionUnidad.php" class="collection-item active">EDICION UNIDAD</a> </div>
									</span>
								</div>
							</li>
							<li>
					...
					<div class="row">
						...
						<table class="responsive-table highlight centered bordered" id="tabla">
							...
							<tbody>
								...
								$sql2 = $mysqli->query( "SELECT * FROM `unidad" );
								$con = 0;
								while ( $fila = mysqli_fetch_assoc( $sql2 ) ) {
									$con = $con + 1;
									echo "<tr>" .
									"<td>" . $fila[ 'idUnidad' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'nombreUnidad' ] . "</td>" .
		...
		<script>
			...
			function actualizar( id_fila ) {
				...
				var nombre = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 1 ).innerHTML;
				var grado = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 2 ).innerHTML;
				
				$.ajax( {
					url: "actualizarUnidad.php",
					method: "POST",
					data: {
