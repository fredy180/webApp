	...
	<body>
				...
				<div class="z-depth-3"> <br>
					...
					<div class="card z-depth-2">
						...
						<div class="collection"> <a href="registroDocente.php" class="collection-item"> REGISTRAR DOCENTE</a>
							...
							<a href="edicionDocente.php" class="collection-item active">EDICION DOCENTE</a>
						</div>
					</div>
				</div>
			</div>
						...
						<table class="responsive-table highlight centered bordered" id="tabla">
							...
							<tbody>
								...
								while ( $fila = mysqli_fetch_assoc( $sql2 ) ) {
									...
									"<td contenteditable='true'> " . $fila[ 'contraDocente' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'nombre' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'apellido' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'gradoEncargado' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'sexo' ] . "</td>" .
									"<td contenteditable='true'>" . $fila[ 'telefono' ] . "</td>" .
									"<td>" .
		...
		<script>
			...
			function actualizar( id_fila ) {
				...
				var grado = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 4 ).innerHTML;
				var sexo = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 5 ).innerHTML;
				var telefono = document.getElementById( "tabla" ).rows[ id_fila ].cells.item( 6 ).innerHTML;

				$.ajax( {
					url: "actualizarDocente.php",
					method: "POST",
					data: {
